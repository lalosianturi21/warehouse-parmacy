<div class="full1">
    <div class="text-dark p-1 text-center shadow-lg fontbg">
        <div class="title1">
        <h1 >Item Units  <i class="fa-solid fa-tag"></i></h1>
    </div>
...
<?php foreach (session()->getFlashdata() as $key => $flash) :?>
    ...
    <button class="btn btn-dark mb-3"><a href="itemunits/new" style="text-decoration: none; color: white">Add item units <i class="fa-solid fa-folder-plus"></i></a></button>
    <div class="col-12 col-xl-10 col-lg-6 float-end">
            <form action="/itemunits" method="get" class="mb-2" id="form-search">
                <div class="input-group">
                    <span class="input-group-text fw-bold text-light"  style="background-color: #1a374d">Cari Item unit</span>
    ...
    <div id="table-result">
            <?= view('itemunits/_itemunits', ['itemunits' => $itemunits]) ?>
        </div>
            </div>
    </div>
