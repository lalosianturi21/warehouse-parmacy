...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12  border p-4 shadow bg-light rounded">
            <div class="col-12">
                <h3 >Add Sales <i class="fa-solid fa-store"></i></h3>
            </div>
                <div class="row g-3 pt-2" >
                    <div class="col-md-12">
                    <label for="invoice_date" class="form-label">Invoice Date <i class="fa-solid fa-calendar-day"></i>   <i class="fa-solid fa-list-ol"></i></label> 
