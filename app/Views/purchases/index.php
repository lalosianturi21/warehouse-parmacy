<div class="full1">
    <div class="text-dark p-1 text-center shadow-lg fontbg">
        <div class="title1">
        <h1 >Purchases <i class="fa-brands fa-shopify"></i> </h1>
    </div>
...
<?php foreach (session()->getFlashdata() as $key => $flash) :?>
    ...
    <button class="btn btn-dark button1 mb-3"><a href="purchases/new" style="text-decoration: none; color: white">Add Purchases <i class="fa-solid fa-cart-shopping"></i></a></button>
    <div class="col-12 col-xl-10 col-lg-6 float-end">
            <form action="/purchases" method="get" class="mb-2" id="form-search">
                <div class="input-group">
                    <span class="input-group-text fw-bold text-light"  style="background-color: #1a374d">Cari Purchases</span>
    ...
    <div id="table-result">
            <?= view('purchases/_purchases', ['purchases' => $purchases]) ?>
        </div>
            </div>
    </div>
