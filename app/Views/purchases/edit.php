...
<form action="/purchases/<?= $purchase['id'] ?>" method="post" enctype="multipart/form-data">
<input type="hidden" name="_method" value="PUT"/>
<div class="container mt-3">
    <div class="row">
        <div class="col-md-12  border p-4 shadow bg-light rounded">
            <div class="col-12">
                <h3 >Edit Purchases <i class="fa-solid fa-cart-shopping"></i></h3>
            </div>
            <div class="row g-3 pt-2" >
                    <div class="col-md-6">
                    <label for="invoice_no" class="form-label">Invoice No   <i class="fa-solid fa-list-ol"></i></label> 
                    <input type="text" class="form-control" placeholder="Enter invoice no"  name="invoice_no" id="invoice_no"  value="<?= $purchase['invoice_no'] ?>" >
                    ...
                    <input type="text" class="form-control" placeholder="Enter invoice date"  name="invoice_date" id="invoice_date"  value="<?= $purchase['invoice_date'] ?>" >
                    ...
                    <div class="col-md-6">
                    <label for="supplier_id" class="form-label">supplier_id    <i class="fa-solid fa-truck-field"></i></label> 
                    <input type="text" class="form-control" placeholder="Enter supplier_id"  name="supplier_id" id="supplier_id"  value="<?= $purchase['supplier_id'] ?>" >
                    ...
                    <input type="text" class="form-control" placeholder="Enter user_id"  name="user_id" id="user_id"  value="<?= $purchase['user_id'] ?>" >
